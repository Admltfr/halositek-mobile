...
class PortofolioView extends GetView<PortofolioController> {
  ...
  Widget _priceAndChat() {
    return Obx(() {
      final isConsultationAvailable =
          controller.consultationFee.value > 0 &&
          controller.consultationDuration.value > 0;
      ...
      return Container(
        ...
        child: InkWell(
          borderRadius: BorderRadius.circular(AppDimensions.radiusPill),
          onTap:
              !isConsultationAvailable || controller.isStartingChat.value
                  ? null
          ...
          child: ClipRRect(
            ...
            child: SizedBox.expand(
              child: Image.network(
                ...
                fit: BoxFit.cover,
                errorBuilder:
                    (_, __, ___) => Image.asset(_dummyImage, fit: BoxFit.cover),
              ),
            ),
          ),
        ),
