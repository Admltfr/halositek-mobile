...
class DesignAddView extends GetView<DesignAddController> {
  const DesignAddView({super.key});
              ...
              Obx(
                () => Skeletonizer(
                  ...
                  child: DesignForm(
                    ...
                    mediaImageUrls: controller.mediaImageUrls.toList(),
                    layoutImageUrls: controller.layoutImageUrls.toList(),
                    ...
                    onRemoveMediaImage: controller.removeMediaImageUrl,
                    onRemoveLayoutImage: controller.removeLayoutImageUrl,
